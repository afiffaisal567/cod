// components/VerticalAccordion.tsx
...
const items = [
  {
    ...
    description:
      "Dukungan penuh untuk screen reader membantu pengguna tunanetra mengakses semua konten dengan mudah.",
  },
  {
    id: 2,
    ...
    description:
      "Semua video dilengkapi subtitle dan transkrip lengkap untuk pengguna tunarungu.",
  },
  {
    id: 3,
    title: "Ukuran Teks",
    ...
    description:
      "Sesuaikan ukuran teks sesuai kenyamanan Anda untuk pengalaman belajar yang optimal.",
  },
  {
    id: 4,
    ...
    description:
      "Navigasi lengkap menggunakan keyboard untuk aksesibilitas maksimal tanpa mouse.",
  },
];